...
- **Exercise todos** — save a completed test or drill for another day, start the same task
  again from the todos page, and keep it queued until the result feels satisfactory.
